...
import type { ComponentsOverrides, ComponentsProps, ComponentsVariants } from '@mui/material';
...
export type MUIDataTableCustomHeadRenderer = Pick<MUIDataTableColumn, 'name' | 'label'> &
  Pick<
    ...
    'customHeadRender' | 'display' | 'filter' | 'sort' | 'download' | 'empty' | 'print' | 'searchable' | 'viewColumns'
  > & {
    index: number;
  };
